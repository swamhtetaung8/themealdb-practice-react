...
const MealCard = ({ meal }) => {
  return (
    <div className=" w-[200px] border rounded-md p-5 shadow-xl hover:rotate-3 transition-all duration-100 relative group ">
      <h2 className=" truncate">{meal.strMeal}</h2>
      <img
        src={meal.strMealThumb}
        className=" h-36 my-5 rounded-lg group-hover:opacity-60 w-full"
        alt=""
      />
      <Link
